...
> Figure suggestion: Add a diagram showing several admissible emotion trajectories over one trial, each yielding the same global label but assigning slightly different local states to a selected segment.
