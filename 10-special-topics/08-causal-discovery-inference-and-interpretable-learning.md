...
> Figure suggestion: Show an end-to-end pipeline from artifact-aware EEG and task context to directed-connectivity estimation, causal graph construction, causal-constrained learning, intervention-aware evaluation, and interpretable output.
