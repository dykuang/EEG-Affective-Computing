...
![EEG foundation model pipeline: large-scale heterogeneous EEG pretraining feeds a shared foundation model, which is then adapted to downstream tasks such as emotion recognition, sleep staging, seizure detection, and workload estimation.](figures/foundation-model-pipeline.png)
