...
> Figure suggestion: Add a three-part diagram showing training on known affect labels, deployment with mixed known and unknown affective states, and clustering of the unknown states into new candidate classes.
